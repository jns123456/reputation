...
PHASE1_FIXES: dict[str, str] = {
    ...
    "%(actor)s sent you a direct message": "%(actor)s te envió un mensaje directo",
    "replied to your comment": "respondió a tu comentario",
    "mentioned you in a": "te mencionó en un",
    "forum post": "post del foro",
    "forum comment": "comentario del foro",
    "mentioned you in a comment on": "te mencionó en un comentario sobre",
    "mentioned you": "te mencionó",
    "Type @username to mention someone.": "Escribe @usuario para mencionar a alguien.",
    "Type @ to mention someone you follow.": "Escribe @ para mencionar a alguien que sigues.",
    "Mention suggestions": "Sugerencias de mención",
    "No followed users match \"@%(query)s\".": "Ningún usuario que sigues coincide con \"@%(query)s\".",
    "Follow people to mention them with @.": "Sigue a personas para mencionarlas con @.",
    "Messages": "Mensajes",
    "Message": "Mensaje",
    "No messages yet": "Aún no hay mensajes",
    "Visit a profile and tap Message to start a chat.": "Visita un perfil y pulsa Mensaje para iniciar un chat.",
    "Select a conversation": "Selecciona una conversación",
    "Choose a chat from the inbox or message someone from their profile.": "Elige un chat del buzón o envía un mensaje desde el perfil de alguien.",
    "Say hello": "Saluda",
    "You:": "Tú:",
    "Unread": "No leído",
    "Back to inbox": "Volver al buzón",
    "Start your conversation with %(name)s.": "Empieza tu conversación con %(name)s.",
    "Write a message…": "Escribe un mensaje…",
    "Send message": "Enviar mensaje",
    "Add a message or attach a photo.": "Escribe un mensaje o adjunta una foto.",
    "Attach photo": "Adjuntar foto",
    "Attached photo": "Foto adjunta",
    "Photo": "Foto",
    "Photo · %(preview)s": "Foto · %(preview)s",
    "Emoji": "Emoji",
    "Remove image": "Quitar imagen",
    "Chat with %(name)s": "Chat con %(name)s",
    "sent you a direct message": "te envió un mensaje directo",
    "Open chat": "Abrir chat",
    "When someone sends you a direct message": "Cuando alguien te envía un mensaje directo",
    "Get notified when someone sends you a private chat message.": "Recibe una notificación cuando alguien te envía un mensaje privado.",
    "Start a new message": "Escribe un mensaje nuevo",
