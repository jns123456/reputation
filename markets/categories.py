...
CANONICAL_CATEGORIES: tuple[CanonicalCategory, ...] = (
    ...
    CanonicalCategory(
        slug="esports",
        name=_("Esports"),
        description=_("Competitive gaming — CS2, LoL, Valorant, and more"),
        tag_slugs=frozenset(
            {
                "esports",
                "counter-strike-2",
        ...
        category_names=frozenset({"esports"}),
        polymarket_tag="esports",
        icon_bg="bg-purple-500/15",
        icon_fg="text-purple-600",
        ring="ring-purple-500/20",
        hero_bg="bg-gradient-to-br from-purple-500/10 to-fuchsia-600/5",
        card_glow="bg-gradient-to-br from-purple-500/20 to-fuchsia-600/10",
        card_hover="from-purple-500/0 to-fuchsia-600/0 group-hover:from-purple-500/10 group-hover:to-fuchsia-600/5",
    ),
    CanonicalCategory(
        slug="sports",
        name=_("Sports"),
