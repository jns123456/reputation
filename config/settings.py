...
# Last contest Sunday (week ending the following Saturday). Empty = open-ended.
# 2026-07-12 → final contest day is Saturday 2026-07-18; no weekly winners after that.
WEEKLY_CONTEST_LAST_WEEK_START = env("WEEKLY_CONTEST_LAST_WEEK_START", default="2026-07-12")
